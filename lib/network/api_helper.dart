...
class ApiBaseHelper {
  ...
  Future<dynamic> orgHelperApi(var apiParams, BuildContext context) async {
    ...
    try {
      final response = await http.post(
        Uri.parse("${_centerlizeBaseUrl}org-info-by-emp"),
        body: json.encode(apiParams),
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  Future<dynamic> postApiForLogin(
    String baseUrl,
    String url,
    var apiParams,
    BuildContext context,
  ...
  Future<dynamic> postAPIWithHeaderWithoutContext(
    String baseUrl,
    String url,
    var apiParams,
    String token,
  ...
  Future<dynamic> postWithAuthorization(
    String baseUrl,
    String url,
    var apiParams,
    BuildContext context,
