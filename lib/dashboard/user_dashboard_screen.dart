...
class _userDashboardScreen extends State<UserDashboardScreen> {
  ...
  String notiStr =
      "Your attendance correction of 14 july 2025 will get locked by today.";
    ...
    if (responseJSON['success'] == true) {
      if (responseJSON['data']['attendanceLog'] != null) {
        String last_check_status =
            responseJSON['data']['attendanceLog']['log_type'].toString();
        if (last_check_status == "null") {
          ...
          if (responseJSON['data']['attendanceTime'] != null) {
            if (responseJSON['data']['attendanceTime']['totalWorkingTime'] !=
                null) {
              logedInTime =
                  responseJSON['data']['attendanceTime']['totalWorkingTime'];
            } else {
