...
import 'package:glueplenew/widget/textfield_widget.dart';
...
class _loginState extends State<LoginScreen> {
        ...
        body: Stack(
          children: [
            Container(
              ...
              decoration: const BoxDecoration(color: AppTheme.loginBackPink),
              child: Padding(
  ...
  getClientOrg() async {
    ...
    var request = {"username": usernameController.text};
  ...
  loginUser() async {
    ...
    var requestModel = {"email": usernameController.text};

    print(requestModel);

    ApiBaseHelper helper = ApiBaseHelper();

    var response = await helper.postApiForLogin(
      baseUrl,
      'login',
      requestModel,
      context,
    ...
    if (responseJSON['success'] == true) {
      ...
      String designation_id = responseJSON['data']['user']['designation_id']
          .toString();
      String department_id = responseJSON['data']['user']['department_id']
          .toString();
      String employee_reporting_manager =
          responseJSON['data']['user']['reported_to'] ?? '';
