...
//     try {
//       setState(() => isLoadingLeaveTypes = true);
...
//       String empId = await MyUtils.getSharedPreferences("emp_id") ?? "";
...
//       if (jsonRes["code"] == 200 && jsonRes["data"] != null) {
//         setState(() {
//           leaveList = jsonRes["data"];
//           isLoadingLeaveTypes = false;
//         });
//       } else {
//         setState(() => isLoadingLeaveTypes = false);
//         Toast.show("Failed to load leave types", duration: Toast.lengthLong);
//       }
//     } catch (e) {
//       setState(() => isLoadingLeaveTypes = false);
//       print("Error fetching leave types: $e");
//       Toast.show("Network error", duration: Toast.lengthLong);
//     }
//   }
...
//                     : Row(
//                         children: List.generate(leaveList.length, (i) {
//                           final leave = leaveList[i];
//                           final leaveName = leave["leave_name"] ?? "Leave";
...
//                   child: TextButton(
//                     onPressed: () {
//                       final selectedLeave = leaveList[selectedType];
//                       final leaveTypeId = selectedLeave['leave_type'];
//                       final leaveName = selectedLeave['leave_name'];
