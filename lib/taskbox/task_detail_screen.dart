                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              _buildKeyValueRow("Project", "Glueple"),
                              const Divider(),
                              _buildKeyValueRow("Title", "New Glueple Task"),
                              const Divider(),
                              _buildKeyValueRow(
                                "Priority",
                                "Low",
                              ...
                              const Divider(),
                              _buildKeyValueRow("Assignee", "John Smith"),
                              const Divider(),
                              _buildKeyValueRow("Watcher", "Test A (TD21)"),
                              const Divider(),
                              _buildKeyValueRow("Task Date", "03-06-2025"),
                              const Divider(),
                              _buildKeyValueRow(
                                "Due Date",
                                "10-06-2025",
                              ...
                              const Divider(),
                              _buildKeyValueRow("Original Estimate", "-"),
                              const Divider(),
                              _buildKeyValueRow(
                                "Spent Time",
                                "00h:00m",
